    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="float-right mr-4">
                <a href="/index" title="Danh sách sản phẩm"><i class="fas fa-list"></i> Danh sách danh mục</a>
            </div>
            <div class="clearfix"></div>
            <div class="card-body">
                <form action="/index/{{$obj->id}}" method="post">
                    @method('PUT')
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        <label>Sale :</label>
                        <input type="text" name="sale" class="form-control" value="{{$obj->sale}}">
                    </div>
                    <div class="form-group">
                        <label>Mô tả :</label>
